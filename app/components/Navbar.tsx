      ...
      >
        <div className="container-custom flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-1">
            {navLinks.map((link) => (
              <Link
                key={link.href}
                href={link.href}
                className="px-3 py-2 text-sm font-medium rounded-lg transition-all duration-300 hover:bg-[var(--glow-color)]"
          ...
          <div className="flex items-center gap-3">
            ...
            {/* CTA Button (desktop) */}
            <Link href="/contact" className="btn-primary hidden md:inline-flex text-sm !py-2.5 !px-5" id="nav-cta">
              Book Consultation
            </Link>
            ...
            <button
              ...
              className="lg:hidden w-10 h-10 rounded-xl flex flex-col items-center justify-center gap-1.5 transition-all"
              style={{
                background: 'var(--glass-bg)',
                border: '1px solid var(--glass-border)',
              }}
